...
<!--start head-->
<?php include_once "./php/main-head.php";?>
<!--end head-->
...
// $dict= get_text($array);
?>
<?php include_once "./php/main-menu.php";?>
      ...
      <div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <div id="div-forms">
                      <form id="login-form " class="login-info">
                          <h3 class="text-center"><?php echo $dict["login"]; ?></h3>
                          <div class="modal-body">
                              <label for="username"><?php echo $dict["phonenum"]; ?></label> 
                              <input id="login_username" name="num" class="form-control" type="text" placeholder="<?php echo $dict["enterphonenum"]; ?>" >
                              <p class="phonenumerror"></p>
                              <div id="uniqueCode">
                                <label for="username"><?php echo $dict["pass"]; ?></label> 
                                <input id="login_password" name="pass" class="form-control" type="password" placeholder="<?php echo $dict["logincode"]; ?>" >
                                <p class="codeerror"></p>
                                <p class="successful"><?php echo $dict["activationcode"]; ?></p>
                                <span id="timer"></span>
                              </div>
                          </div>
                          <div class="modal-footer text-center">
                              <div>
                                  <button type="submit" class="btn btn-general btn-white continueBtn"><?php echo $dict["continue"]; ?></button>
                                  <button type="submit" class="btn btn-general btn-white loginBtn"><?php echo $dict["login"]; ?></button>
                              </div>
                          </div>
                      </form>
                  </div>
...
======================================================--> 
              ...
              <div class="row">
                ...
                <div class="col-md-3 col-sm-6 ">
                  ...
                  <ul class="list-unstyled link-list">
                    <li><a class="about-us">About us</a><i class="fa fa-angle-right"></i></li> 
    ...
    <script src="js/main-bootstrap/main-bootstrap-ltr.min.js"></script>
    <script src="js/wow/wow.min.js"></script>
    <script src="js/main-owl-carousel/owl.carousel.min.js"></script>

    <!-- Plugin JavaScript -->
    <script src="js/main-jquery-easing/jquery.easing.min.js"></script> 
